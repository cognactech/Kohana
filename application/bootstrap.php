...
/**
 * load modules using modules.php file
 */
require_once APPPATH.'modules.php';

/**
 * load routes.php this file containes all calls to the Route library for url rewriting
 */
